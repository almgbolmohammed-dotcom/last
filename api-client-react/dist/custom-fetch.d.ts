...
/**
 * Set a tenant slug that is injected as the X-Tenant-Slug header on every
 * request. Used for multi-tenant SaaS routing on the API.
 * Pass `null` to clear the tenant slug.
 */
export declare function setTenantSlug(slug: string | null): void;
/**
