...
/**
 * @summary Settle a debt fully or partially (moves paid amount to income)
 */
export declare const settleDebt: (id: number, settleDebtBody?: SettleDebtBody, options?: RequestInit) => Promise<IncomeRecord>;
...
export type SettleDebtMutationBody = BodyType<SettleDebtBody> | undefined;
