...
export const settleDebt = async (id: number,
    settleDebtBody?: SettleDebtBody, options?: RequestInit): Promise<IncomeRecord> => {
...
export const getSettleDebtMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof settleDebt>>, TError,{id: number;data?: BodyType<SettleDebtBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof settleDebt>>, TError,{id: number;data?: BodyType<SettleDebtBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof settleDebt>>, {id: number;data?: BodyType<SettleDebtBody>}> = (props) => {
          const {id,data} = props ?? {};
...
export const useSettleDebt = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof settleDebt>>, TError,{id: number;data?: BodyType<SettleDebtBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: number;data?: BodyType<SettleDebtBody>},
        TContext
      > => {
