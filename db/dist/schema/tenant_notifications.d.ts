export declare const tenantNotificationsTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "tenant_notifications";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "tenant_notifications";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=tenant_notifications.d.ts.map