...
export const insertRentalSchema = createInsertSchema(rentalsTable).omit({ id: true, completedAt: true, daysCount: true, totalAmount: true, status: true, startedAt: true, tenantId: true });
